...
class SH_Seo
{
	...
	function title( $title )
	{
		...
		if( is_singular() ) $meta_title = $this->home_title( $title ); // if the single post template.
	...
	function head() 
	{
		...
		if( is_tax() || is_category() || is_tag() ) $this->tax_meta();
		if( is_home() || is_front_page() ) $this->home_meta();
